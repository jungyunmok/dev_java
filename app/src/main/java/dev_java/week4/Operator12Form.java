...
public class Operator12Form implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (jbtn_account == obj) {// 연산 버튼
      ...
      if (jtf_result.getText().contains("+")) {
        jtf_result.setText(jtf_result.getText() + " = " + (account("+")));
      } else if (jtf_result.getText().contains("-")) {
        jtf_result.setText(jtf_result.getText() + " = " + (account("-")));
      } else if (jtf_result.getText().contains("*")) {
        jtf_result.setText(jtf_result.getText() + " = " + (account("*")));
      } else if (jtf_result.getText().contains("/")) {
      ...
      if (jtf_result.getText().contains("=")) {
        jtf_result.setText("" + String.valueOf(i));
      } else {
        jtf_result.setText(jtf_result.getText() + String.valueOf(i));
      }
      vTest.add(i);
      ...
      if (jtf_result.getText().contains("=")) {
        jtf_result.setText("" + String.valueOf(j));
      } else {
        jtf_result.setText(jtf_result.getText() + String.valueOf(j));
      }
      vTest.add(j);
      ...
      // insert here
      jtf_result.setText(jtf_result.getText() + jbtn_plus.getText());

    } else if (jbtn_minus == obj) {// 빼기 연산자
      // insert here
      jtf_result.setText(jtf_result.getText() + jbtn_minus.getText());

    } else if (jbtn_mult == obj) {// 곱하기 연산자
      // insert here
      jtf_result.setText(jtf_result.getText() + jbtn_mult.getText());

    } else if (jbtn_div == obj) {// 나누기 연산자
      // insert here
      jtf_result.setText(jtf_result.getText() + jbtn_div.getText());
    }
