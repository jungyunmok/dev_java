...
public class LoginForm extends JFrame {
  // 선언부
  String imgPath = "D:\\vscode_java\\dev_java\\app\\src\\main\\java\\dev_java\\images\\login\\"; // 반드시 뒤에 \\ 붙일것!
  ImageIcon imageIcon = new ImageIcon(imgPath + "main.png");
  JLabel jlb_id = new JLabel("아이디");
  JTextField jtf_id = new JTextField("tomato");
  JLabel jlb_pw = new JLabel("비밀번호");
  JPasswordField jp_pw = new JPasswordField();
  ...
  public void initDisplay() {
    ...
    jlb_pw.setFont(font);
    jp_pw.setBounds(110, 240, 185, 40);
    this.add(jlb_pw);
    this.add(jp_pw);
